...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.pass}">
            <li class="fieldcontain">
                <span id="pass-label" class="property-label"><g:message code="user.pass.label" default="Pass"/></span>

                <span class="property-value" aria-labelledby="pass-label"><g:fieldValue bean="${userInstance}"
                                                                                        field="pass"/></span>
